...
if option == "💱 Currency Converter":
    ...
    st.write("Developed by Mavia")
    currency_list = ["USD", "EUR", "GBP", "INR", "AUD", "CAD", "JPY", "CNY", "CHF", "NZD", "ZAR", "SGD", "HKD", "NOK", "SEK", "DKK", "RUB", "BRL", "MXN", "MYR", "THB", "IDR", "PHP", "PLN", "TRY", "HUF", "CZK", "ILS", "CLP", "PEN", "COP", "SAR", "AED", "ARS", "EGP", "NGN", "PKR", "BDT", "VND"]
    c1, c2 = st.columns(2)
    with c1:
